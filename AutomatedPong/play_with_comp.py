...
class PlayWithComp(Pong):
    def play(self):
        ...
        while True:
            ...
            if self.ball.ycor() < self.paddle_a.ycor() and abs(self.paddle_a.ycor() - self.ball.ycor()) > 10:
                self.paddle_a_down()
            elif self.ball.ycor() > self.paddle_a.ycor() and abs(self.paddle_a.ycor() - self.ball.ycor()) > 10:
                self.paddle_a_up()
